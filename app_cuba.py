...
def main():
    ...
    if selected == t["team_overview"]:
        st.header(f"\U0001F1E8\U0001F1FA {t['team_overview']}")
    ...
    st.header(f"\U0001F1E8\U0001F1FA {_display_name(player['name'])}")
