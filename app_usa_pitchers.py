"""WBC 2026 USA Pitching Scouting Dashboard."""
...
TEXTS = {
    "EN": {
        "title": "USA Pitching Scouting Report",
...
# Data loading
# ---------------------------------------------------------------------------
DATA_PATH = pathlib.Path(__file__).parent / "data" / "usa_pitchers_statcast.csv"
...
def main():
    st.set_page_config(
        page_title="USA Pitching \u2014 WBC 2026",
        page_icon="\U0001F1FA\U0001F1F8",
        layout="wide",
    )
