...
def main():
    ...
    if selected == t["team_overview"]:
        st.header(f"\U0001F1EE\U0001F1F9 {t['team_overview']}")
    ...
    st.header(f"\U0001F1EE\U0001F1F9 {_display_name(player['name'])}")
