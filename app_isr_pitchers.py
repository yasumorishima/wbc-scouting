"""WBC 2026 Israel Pitching Scouting Dashboard."""
...
from players_isr_pitchers import ISR_PITCHERS, PITCHER_BY_NAME
...
TEXTS = {
    "EN": {
        "title": "Israel Pitching Scouting Report",
...
# Data loading
# ---------------------------------------------------------------------------
DATA_PATH = pathlib.Path(__file__).parent / "data" / "isr_pitchers_statcast.csv"
...
def main():
    st.set_page_config(
        page_title="Israel Pitching \u2014 WBC 2026",
    ...
    _name_ja_map = {p["name"]: p.get("name_ja", "") for p in ISR_PITCHERS}
    ...
    pitcher_names = [t["team_overview"]] + [p["name"] for p in ISR_PITCHERS]
