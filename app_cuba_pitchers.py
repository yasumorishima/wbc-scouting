"""WBC 2026 Cuba Pitching Scouting Dashboard."""
...
TEXTS = {
    "EN": {
        "title": "Cuba Pitching Scouting Report",
...
# Data loading
# ---------------------------------------------------------------------------
DATA_PATH = pathlib.Path(__file__).parent / "data" / "cuba_pitchers_statcast.csv"
...
def main():
    ...
    pitcher_names = [t["team_overview"]] + [p["name"] for p in CUBA_PITCHERS]
